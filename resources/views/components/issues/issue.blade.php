...
<div class="relative flex w-full pr-0 duration-75 ease-in sm:items-stretch hover:bg-gradient-to-bl hover:from-violet-800 dark:hover:bg-border/30">
    <a class="hidden w-full h-full min-w-0 py-4 pl-4 pr-3 my-auto overflow-auto rounded-md cursor-pointer sm:block sm:pl-5 sm:py-5">
        <x-issues.issue-tag>Fact</x-issues.issue-tag>
